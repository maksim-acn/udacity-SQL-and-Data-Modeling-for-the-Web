---
title: "Project: Fyyur - Project Instructions"
source: "https://learn.udacity.com/nd0044?version=5.2.0&partKey=cd0046&lessonKey=e0630afb-6b78-4551-974b-f6854d303dc1&conceptKey=2da2e03b-93a6-425f-811c-839de673b80b"
author:
published:
created: 2026-04-29
description:
...
[Lesson](https://learn.udacity.com/nd0044?version=5.2.0&partKey=cd0046&lessonKey=e0630afb-6b78-4551-974b-f6854d303dc1&conceptKey=2da2e03b-93a6-425f-811c-839de673b80b&tab=lesson) [Downloads](https://learn.udacity.com/nd0044?version=5.2.0&partKey=cd0046&lessonKey=e0630afb-6b78-4551-974b-f6854d303dc1&conceptKey=2da2e03b-93a6-425f-811c-839de673b80b&tab=resources) [Cloud Resources](https://learn.udacity.com/nd0044?version=5.2.0&partKey=cd0046&lessonKey=e0630afb-6b78-4551-974b-f6854d303dc1&conceptKey=2da2e03b-93a6-425f-811c-839de673b80b&tab=cloud-resources)

## Fyyur: Artist Booking Site

We’d like to create a booking site Fy-yur that facilitates bookings between artists who can play at venues, and venues who want to book artists.
...
You can find all of the starter code for this project in the Project Workspace. If you choose to work locally, this information may also be found at [this GitHub repository(opens in a new tab)](https://github.com/udacity/cd0046-SQL-and-Data-Modeling-for-the-Web).
...
You must have the **HTML**, **CSS**, and **Javascript** with [Bootstrap 3(opens in a new tab)](https://getbootstrap.com/docs/3.4/customize/) for our website's frontend. If you are working locally, further instructions are contained in the repo README file.

Install [Bootstrap 3(opens in a new tab)](https://getbootstrap.com/docs/3.3/getting-started/) for the website's frontend:
...
4. As a fellow developer on this application, I should be able to run `flask db migrate`, and have my local database (once set up and created) be populated with the right tables to run this application and have it interact with my local postgres server, serving the application's needs completely with real data I can seed my local database with.
	- The models should be completed (see TODOs in the `Models` section of `app.py`) and model the objects used throughout Fyyur.
		- Define the models in a different file to follow [Separation of Concerns(opens in a new tab)](https://en.wikipedia.org/wiki/Separation_of_concerns) design principles. You can refactor the models to a new file, such as `models.py`.
...
If you choose to work locally, more detailed information regarding setup can be found in the README [here(opens in a new tab)](https://github.com/udacity/cd0046-SQL-and-Data-Modeling-for-the-Web). Working in the project workspace, follow the instructions below:
...
Navigate to the project homepage in the virtual desktop (by clicking the "Preview" button in the workspace) [(opens in a new tab)](http://127.0.0.1:3000/) [http://127.0.0.1:3000/(opens in a new tab)](http://127.0.0.1:3000/) or [(opens in a new tab)](http://localhost:3000/) [http://localhost:3000(opens in a new tab)](http://localhost:3000/) or in the browser of your local virtual environment, if you are working locally, use [(opens in a new tab)](http://127.0.0.1:5000/) [http://127.0.0.1:5000/(opens in a new tab)](http://127.0.0.1:5000/) or [(opens in a new tab)](http://localhost:5000/) [http://localhost:5000(opens in a new tab)](http://localhost:5000/).
